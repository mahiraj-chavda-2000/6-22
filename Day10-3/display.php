...
$mysqli = mysqli_connect('localhost', 'root', '', 'userdata');
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $items['email']; ?></td>
                                                    <td><?= $items['rights']; ?></td>
													<td><a href="update.php?id=<?= $items['id']; ?>&username=<?= $items['username']; ?>&email=<?= $items['email']; ?>&rights=<?= $items['rights']; ?>" class="btn btn-info">Edit/Update</a></td>
